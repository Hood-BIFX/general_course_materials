...
* Ethical dimension: Students using AI should be transparent about their use and make sure it aligns with academic integrity. The ICMJE recommendations suggest, for example, that authors should explicitly acknowledge how they used AI in their work, but that the AI tool should not be included as an author, since it is neither accountable nor able to reliably check it's work [@icmje_recommendations_2025].
  ...
  * Limited AI tools for narrative: Unless otherwise instructed, use of AI for writing narrative on assignments is limited. It may be used to provide feedback on writing (e.g. language and grammar suggestions) - **in no case should text be copy/pasted from a generative AI tool for writing assignments**. In general, you may use AI as a resource as you complete assignments, but it should not be used to provide solutions to exercises or to write for you. You are ultimately accountable for the work you turn in.
